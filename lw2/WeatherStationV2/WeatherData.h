...
// ----------------------------------------------
// Универсальный класс для хранения статистики по одному параметру
// ----------------------------------------------
class CStatsData
{
public:
...
// ----------------------------------------------
// Отображение статистики по всем параметрам (печать через общий цикл)
// ----------------------------------------------
